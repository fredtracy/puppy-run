...
## Cow moo sound (public/audio/moo.wav)

Source: [Wikimedia Commons — "Single Cow Moo.ogg"](https://commons.wikimedia.org/wiki/File:Single_Cow_Moo.ogg)

- © MichaeltheFox8621 — [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/)
- Converted from Ogg Vorbis to WAV for cross-browser playback (Safari does not support Ogg Vorbis). No other changes made.

## HDRI sky (public/hdri/autumn_field_puresky_1k.hdr)

Source: [Poly Haven — "Autumn Field Puresky"](https://polyhaven.com/a/autumn_field_puresky)

- [CC0](https://polyhaven.com/license) — public domain, no attribution required. Used unmodified for image-based environment lighting.

## Brick wall PBR textures (public/textures/brick_wall_001/)
